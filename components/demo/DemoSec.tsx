 ...
 return (
  <section className="w-full bg-black">
   <div className="flex flex-col container justify-center items-center pt-[72px] mx-auto pb-16!  text-center md:pb-20 md:pt-12">
    ...
    <h2
     className="font-aeonik leading-snug lg:leading-tight text-3xl md:text-4.5xl lg:text-5xl text-balance"
     style={{ color: "#bbdef2" }}>
     Services That Transform Your Business
    </h2>
    <p
     className="mt-4 lg:mt-2 leading-[1.60] lg:text-xl text-balance [white-space:inherit] block font-normal"
     style={{ color: "#bbdef2" }}>
