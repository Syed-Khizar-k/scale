 ...
 const cards = [
  {
   ...
   href: "#",
   alt: "RocketOps.ai small business automation icon – workflow automation platform built for SMEs and startups in UAE and GCC",
  },
  {
   ...
   href: "#",
   alt: "Open stack automation illustration – n8n and open-source AI integration ecosystem by RocketOps.ai with no vendor lock-in",
  },
  {
   ...
   href: "#",
   alt: "ERP integration icon – RocketOps.ai deep AI workflow automation with SAP, Oracle, and business management systems",
  },
  {
   ...
   href: "#",
   alt: "AI-enhanced automation icon – RocketOps.ai voice, chat, and predictive AI agent automation capabilities for enterprises",
  },
  {
   ...
   href: "#",
   alt: "Guaranteed ROI performance icon – RocketOps.ai automation results, business growth, and cost efficiency guarantee",
  },
  {
   ...
   href: "#",
   alt: "Local and regional automation compliance icon – RocketOps.ai UAE GCC data privacy and regulatory compliance support",
  },
 ];
