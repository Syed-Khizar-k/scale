...
// Validate ../../app/sitemaps/general.xml/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/sitemaps/general.xml">> = Specific
  const handler = {} as typeof import("../../app/sitemaps/general.xml/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
